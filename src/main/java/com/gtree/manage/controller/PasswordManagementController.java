...
/**
 * 
 * @author SrinivasuluP This controller is called (POST) to reset passwords of
 *         the users
 */
@RestController
...
public class PasswordManagementController {
	...
	/**
	 * This method is called to reset the password by passing email , new password
	 * and confirm password. User is determined/found by email and necessary
	 * validations are done before the new password is stored/updated into database
	 * The new password is persisted into the db table and an Event
	 * 'PassworResetEvent' is created.
	 * 
	 * @param resetRequest
	 * @return
	 */
